...
/* BINDTOOL_HEADER_FILE_HASH(d181ca85f83fa4f7190026d89cea7dbd)                     */
/***********************************************************************************/
...
void bind_frame_sync(py::module& m)
{
    ...
    using frame_sync    = gr::cs330project22::frame_sync;


    py::class_<frame_sync, gr::sync_block, gr::block, gr::basic_block,
